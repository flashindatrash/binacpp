...
//--------------------
// Get lending account information. (SIGNED)
/*
...
void
BinaCPP::get_savings( long recvWindow,  Json::Value &json_result )
{

    BinaCPP_logger::write_log( "<BinaCPP::get_savings>" ) ;

    if ( api_key.size() == 0 || secret_key.size() == 0 ) {
        BinaCPP_logger::write_log( "<BinaCPP::get_savings> API Key and Secret Key has not been set." ) ;
        return ;
    }
    ...
    BinaCPP_logger::write_log( "<BinaCPP::get_savings> url = |%s|" , url.c_str() ) ;
    ...
    if ( str_result.size() > 0 ) {
        ...
        try {
            ...
            BinaCPP_logger::write_log( "<BinaCPP::get_savings> Error ! %s", e.what() );
        }
        BinaCPP_logger::write_log( "<BinaCPP::get_savings> Done." ) ;

    } else {
        BinaCPP_logger::write_log( "<BinaCPP::get_savings> Failed to get anything." ) ;
    }
...
//--------------------
// Get Flexible Product Position. (SIGNED)
/*
...
void
BinaCPP::get_flexibleProducts(
        const char *asset,
        long recvWindow,
        Json::Value &json_result )
{
    BinaCPP_logger::write_log( "<BinaCPP::get_flexibleProducts>" ) ;

    if ( api_key.size() == 0 || secret_key.size() == 0 ) {
        BinaCPP_logger::write_log( "<BinaCPP::get_flexibleProducts> API Key and Secret Key has not been set." ) ;
        return ;
    }
    ...
    BinaCPP_logger::write_log( "<BinaCPP::get_flexibleProducts> url = |%s|" , url.c_str() ) ;
    ...
    if ( str_result.size() > 0 ) {
        ...
        try {
            ...
            BinaCPP_logger::write_log( "<BinaCPP::get_flexibleProducts> Error ! %s", e.what() );
        }
        BinaCPP_logger::write_log( "<BinaCPP::get_flexibleProducts> Done." ) ;

    } else {
        BinaCPP_logger::write_log( "<BinaCPP::get_flexibleProducts> Failed to get anything." ) ;
    }
...
//--------------------
// Redeem Flexible Product. (SIGNED)
/*
...
BinaCPP::redeem_flexibleProduct(
        ...
        Json::Value &json_result )
{
    BinaCPP_logger::write_log( "<BinaCPP::redeem_flexibleProduct>" ) ;

    if ( api_key.size() == 0 || secret_key.size() == 0 ) {
        BinaCPP_logger::write_log( "<BinaCPP::redeem_flexibleProduct> API Key and Secret Key has not been set." ) ;
        return ;
    }
    ...
    BinaCPP_logger::write_log( "<BinaCPP::redeem_flexibleProduct> url = |%s|, post_data = |%s|" , url.c_str(), post_data.c_str() ) ;
    ...
    if ( str_result.size() > 0 ) {
        ...
        try {
            ...
            BinaCPP_logger::write_log( "<BinaCPP::redeem_flexibleProduct> Error ! %s", e.what() );
        }
        BinaCPP_logger::write_log( "<BinaCPP::redeem_flexibleProduct> Done." ) ;

    } else {
        BinaCPP_logger::write_log( "<BinaCPP::redeem_flexibleProduct> Failed to get anything." ) ;
    }
